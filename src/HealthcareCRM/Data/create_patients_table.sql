...
CREATE INDEX IF NOT EXISTS [IX_MedicalHistories_PatientId] ON [MedicalHistories] ([PatientId]);
CREATE INDEX IF NOT EXISTS [IX_MedicalHistories_VisitDate] ON [MedicalHistories] ([VisitDate]);
